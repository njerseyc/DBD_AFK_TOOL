...
# &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;此项目已不再维护
...
## 基本设置  
★&ensp;如果你是第一次使用本工具，需要先运行 `注册dll.bat` 文件。
...
&ensp;●&ensp;第一次使用时，确保你在角色大厅，然后点击`“检索”`。软件会遍历你的屠夫角色，遍历完成之后会提示检索成功。  

&ensp;●&ensp;如果检索之后弹窗返回不成功，请检查和你的角色是否不匹配或者乱码，需要重新检索。  

&ensp;●&ensp;如果你的角色数量有所变化就需要重新检索。  

&ensp;●&ensp;点击`“配置”`，选择你想轮换的角色。但是切勿选择你并不拥有的角色。  
