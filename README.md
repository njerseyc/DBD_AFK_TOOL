...
★&ensp;使用本脚本请 ***全屏【16：9】*** 游戏，在匹配大厅开启脚本！
...
## 挂机模式
★&ensp;角色自动轮换模式：自动轮换人类/屠夫角色，若选择此模式，运行脚本后输入你需要轮换的角色数量（比如：你想刷20个屠夫，让他们轮换挂机，就输入20）；  

&ensp;&ensp;&ensp;●&ensp;选择 *角色自动轮换* 模式，请选择本阵营 **第一个角色** *【德怀特/设陷者】* 并 ***装配好所有轮换角色的技能*** 再开始运行脚本！【推荐屠夫使用】  
...
### 可能出现的一些问题
- 启动脚本后请勿操作鼠标、键盘，耐心等待，挂机过程中出现错误，请于匹配大厅重启脚本，结束脚本请按F10。
